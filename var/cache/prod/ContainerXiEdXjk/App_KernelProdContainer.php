...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\GenreController' => 'getGenreControllerService',
            ...
            'App\\Controller\\GenreController' => 'getGenreController2Service',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ugbWVGT5qs', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        return $this->privates['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['App\\Security\\Voter\\UserVoter'] ?? ($this->privates['App\\Security\\Voter\\UserVoter'] = new \App\Security\Voter\UserVoter()));
