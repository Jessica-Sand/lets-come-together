...
class getStyleControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/Admin/StyleController.php';

        $container->services['App\\Controller\\Admin\\StyleController'] = $instance = new \App\Controller\Admin\StyleController();

        $instance->setContainer(($container->privates['.service_locator.W9y3dzm'] ?? $container->load('get_ServiceLocator_W9y3dzmService'))->withContext('App\\Controller\\Admin\\StyleController', $container));
